                    ...
                    $json_data = json_encode([
                        ...
                        "embeds" => [
                            [
                                ...
                                // Embed Description
                                "description" => $body->data->payer->firstName . " " . $body->data->payer->lastName . " vient de passer une commande pour le bal de promo 2023 d'un total de ".strval($body->data->amount->total)."!",
